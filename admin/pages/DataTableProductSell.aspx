<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataTableProductSell.aspx.cs" Inherits="admin_pages_DataTableProductSell" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "http://localhost:32409/DatatableWebService.asmx/ProductOrderQuantity",
