<%@ Page Title="" Language="C#" MasterPageFile="~/admin/pages/admin.master" AutoEventWireup="true" CodeFile="UpdateProduct.aspx.cs" Inherits="admin_pages_UpdateProduct" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div role="form">
                                        ...
                                        <asp:button runat="server" text="Update" cssClass="btn btn-primary" ID="btnUpdateProduct" OnClick="btnAddProduct_Click"/>
                                        &nbsp
