<%@ Page Title="" Language="C#" MasterPageFile="~/admin/pages/admin.master" AutoEventWireup="true" CodeFile="ViewOrder.aspx.cs" Inherits="admin_ViewOrder" %>
                            ...
                            <table class="nav-justified table table-bordered table-striped">
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <asp:Image ID="Image1" runat="server" Height="43px" ImageUrl="~/admin/pages/Images/Images.jpg" Width="121px" />
                                        <br />
                                        Issue date:
