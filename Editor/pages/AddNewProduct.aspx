<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="AddNewProduct.aspx.cs" Inherits="admin_pages_AddNewProduct" %>
                                    ...
                                    <div class="col-lg-6">
                                        <div role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                &nbsp;<asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtPrice" ErrorMessage="Invalid price" MaximumValue="1000000" MinimumValue="1" Type="Currency"></asp:RangeValidator>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br />
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorProductImage" runat="server" ControlToValidate="fileProductImage" ErrorMessage="Product Image is Invalid!" ValidationExpression="^([0-9a-zA-Z_\-~ :\\])+(.jpg|.JPG|.jpeg|.JPEG|.bmp|.BMP|.gif|.GIF|.png|.PNG)$"></asp:RegularExpressionValidator>
                                            </div>
